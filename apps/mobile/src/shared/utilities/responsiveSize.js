 ...
 */
export const round = (value) => Math.round(PixelRatio.roundToNearestPixel(value));
/**
 ...
 */
export const deviceSpecific = (values) => {
    const deviceSize = getDeviceSize();
 ...
 */
export const orientationSpecific = (values) => {
...
export { scaleWidth as rw, scaleHeight as rh, scaleSize as rs2, moderateScale as ms, responsiveFontSize as rf, };
