...
export const useAnimatedContextMenu = (config, onHide) => {
    ...
    const calculateVerticalPosition = (estimatedHeight, triggerBounds) => {
        ...
        return spaceBelow > spaceAbove
            ...
            : Math.max(rs(16) + insets.top, triggerBounds.y - estimatedHeight + rs(12));
    };
    const menuPosition = useMemo(() => {
        ...
        const y = config.position
            ...
            : Math.min(screenHeight - insets.bottom - estimatedHeight - rs(16), rs(100));
        return {
            left: x,
            top: y,
            width: menuWidth,
