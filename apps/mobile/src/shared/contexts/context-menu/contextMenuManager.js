...
export const ContextMenuContainer = () => {
    ...
    return menu ? (_jsx(SafeAreaView, { style: styles.container, pointerEvents: "box-none", children: _jsx(View, { style: styles.content, pointerEvents: "box-none", children: _jsx(AnimatedContextMenu, { config: menu, onHide: hideMenu }) }) })) : null;
};
