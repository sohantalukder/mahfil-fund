...
export const buttonStyles = ({ borderRadius, bgColor, colors, }) => StyleSheet.create({
    container: {
        alignItems: 'center',
...
export const createRippleStyles = (rippleColor, radius, rippleOpacity, borderRadius, overflow) => StyleSheet.create({
    button: {
