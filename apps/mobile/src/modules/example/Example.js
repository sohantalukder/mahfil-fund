...
function Example() {
  ...
  return _jsx(SafeScreen, {
    children: _jsxs(ScrollView, {
      showsVerticalScrollIndicator: false,
      children: [
        _jsx(View, {
          style: [layout.itemsCenter, gutters.marginTop_40],
          children: _jsx(View, {
            style: [
              layout.relative,
              {
        ...
        _jsxs(View, {
          style: [gutters.paddingHorizontal_32, gutters.marginTop_32],
          children: [
            _jsx(Text, {
              variant: 'heading1',
              weight: 'bold',
              style: [typographies.heading1, styles.centerText],
              children: t('boilerplate.screen_example.title'),
            }),
            _jsx(Text, {
              variant: 'body1',
              color: 'secondary',
              style: [gutters.marginTop_16, styles.centerTextWithLineHeight],
              children: t('boilerplate.screen_example.description'),
            }),
          ],
        }),
        userData &&
          _jsx(View, {
            ...
            children: _jsx(Card, {
              ...
              padding: 20,
              children: _jsxs(View, {
                style: [layout.row, layout.itemsCenter, gutters.gap_16],
                children: [
                  _jsx(Image, {
        ...
        _jsxs(View, {
          ...
          children: [
            _jsx(Text, {
              ...
              children: t('boilerplate.screen_example.explore_features'),
            }),
          ...
          children: _jsxs(Card, {
            ...
            children: [
              _jsx(Text, {
                ...
                children: t('boilerplate.screen_example.stats.title'),
              }),
              _jsxs(View, {
                  ...
                  _jsxs(View, {
                    ...
                    children: [
                      ...
                      _jsx(Text, {
                        ...
                        color: 'secondary',
                        children: t(
                          'boilerplate.screen_example.stats.components'
                        ),
                      }),
                    ],
                  }),
                  _jsxs(View, {
                    ...
                    children: [
                      ...
                      _jsx(Text, {
                        ...
                        color: 'secondary',
                        children: t(
                          'boilerplate.screen_example.stats.utilities'
                        ),
                      }),
                    ],
                  }),
                  _jsxs(View, {
                    ...
                    children: [
                      ...
                      _jsx(Text, {
                        ...
                        color: 'secondary',
                        children: t(
                          'boilerplate.screen_example.stats.languages'
                        ),
                      }),
                    ],
                  }),
                  _jsxs(View, {
                    ...
                    children: [
                      ...
                      _jsx(Text, {
                        ...
                        color: 'secondary',
                        children: t(
                          'boilerplate.screen_example.stats.possibilities'
                        ),
                      }),
                    ],
                  }),
