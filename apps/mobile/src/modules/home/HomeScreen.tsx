    ...
    <View style={{ flex: 1, padding: 16 }}>
      ...
      {isOfflineMode && (
        ...
        >
          ...
          <Text>
            We&apos;ll re-validate your session when internet returns.
          </Text>
        </View>
      )}
      ...
      <View style={{ display: 'flex', gap: 12 }}>
        <Button
          title="Donors"
          onPress={() => navigation.navigate(routes.donors)}
        />
        <View style={{ height: 8 }} />
        <Button
          title="Donations"
      ...
      <Text style={{ color: '#6b7280', marginTop: 24 }}>
        Next: dashboards, donations/expenses, reports, and full offline sync
        queue UI.
      </Text>
    </View>
  );
