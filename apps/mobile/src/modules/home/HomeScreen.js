...
export default function HomeScreen({ navigation }) {
    ...
    return (_jsxs(View, { style: { flex: 1, padding: 16 }, children: [!isOnline && (_jsxs(View, { style: {
                    ...
                    borderRadius: 8,
                    marginBottom: 12,
                }, children: [_jsx(Text, { style: { fontWeight: '700' }, children: "Offline access enabled" }), _jsx(Text, { children: "We'll re-validate your session when internet returns." })] })), _jsx(Text, { style: { fontSize: 20, fontWeight: '700', marginBottom: 8 }, children: "Dashboard" }), _jsx(Text, { style: { color: '#6b7280', marginBottom: 16 }, children: user ? `Signed in as ${user.email ?? user.authUserId}` : 'Signed in' }), _jsxs(View, { style: { display: 'flex', gap: 12 }, children: [_jsx(Button, { title: "Donors", onPress: () => navigation.navigate(routes.donors) }), _jsx(View, { style: { height: 8 } }), _jsx(Button, { title: "Donations", onPress: () => navigation.navigate(routes.donations) }), _jsx(View, { style: { height: 8 } }), _jsx(Button, { title: "Expenses", onPress: () => navigation.navigate(routes.expenses) }), _jsx(Button, { title: "Sync Center", onPress: () => navigation.navigate(routes.syncCenter) })] }), _jsx(Text, { style: { color: '#6b7280', marginTop: 24 }, children: "Next: dashboards, donations/expenses, reports, and full offline sync queue UI." })] }));
}
